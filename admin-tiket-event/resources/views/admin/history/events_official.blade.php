...
@section('title', 'History Event Official')
@section('header', 'History Event Official')

@section('content')

<div class="card">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
        <h3 style="margin:0;">Activity Logs: Official Events</h3>

        <form action="{{ route('admin.history.events_official') }}" method="GET" style="display: flex; gap: 0.5rem; margin: 0; flex: 1; flex-wrap: wrap; align-items: center;">
            ...
            @if(request('search'))
                <a href="{{ route('admin.history.events_official') }}" class="btn" style="background: #E5E7EB; color: #374151;">Clear</a>
            @endif
        </form>
    </div>
    ...
    <div style="overflow-x: auto;">
        <table>
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="4" style="text-align: center; padding: 2rem; color: #6B7280;">Belum ada log aktivitas untuk Event Official.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
