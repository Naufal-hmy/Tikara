...
export default function EditEventScreen() {
        ...
        const loadInitialData = async () => {
            ...
            if (eventData) {
                setForm({
                    ...
                    total_quota: eventData.total_quota?.toString() || '',
    ...
    const handleSave = async () => {
        if (!form.title || !form.price || !form.date || !form.time || !form.location || !form.address_detail || !form.total_quota) {
            return Alert.alert("Eits!", "Mohon isi field wajib (Nama, Tanggal, Jam, Lokasi, Alamat, Harga, Kuota).");
        }
        ...
        try {
            ...
            const { error } = await eventService.updateEvent(Number(id), {
                ...
                // Kita biarkan remaining_quota diatur oleh database saat update,
                // tapi jika tidak ada kita kirim yang sama dengan total
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.row}>
                    <View style={[styles.formGroup, { flex: 1 }]}>
                        ...
                        <TextInput style={styles.input} value={form.total_quota} keyboardType="numeric" onChangeText={(t) => setForm({ ...form, total_quota: t })} />
                    </View>
                </View>
                ...
                <View style={styles.formGroup}>
                    ...
                    <TextInput style={[styles.input, { height: 60, textAlignVertical: 'top' }]} value={form.address_detail} multiline onChangeText={(t) => setForm({ ...form, address_detail: t })} />
                </View>
