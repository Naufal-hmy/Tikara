...
@section('title', 'History Orders')
@section('header', 'Activity Logs: Orders')

@section('content')

<div class="card">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
        <h3 style="margin:0;">Activity Logs: Orders</h3>

        <form action="{{ route('admin.history.orders') }}" method="GET" style="display: flex; gap: 0.5rem; margin: 0; flex: 1; flex-wrap: wrap; align-items: center;">
            ...
            @if(request('search'))
                <a href="{{ route('admin.history.orders') }}" class="btn" style="background: #E5E7EB; color: #374151;">Clear</a>
            @endif
        </form>
    </div>
    ...
    <div style="overflow-x: auto;">
        <table>
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="4" style="text-align: center; padding: 2rem; color: #6B7280;">Belum ada log aktivitas untuk Order.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
