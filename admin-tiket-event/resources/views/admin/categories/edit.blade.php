...
<div class="card" style="max-width: 600px;">
    ...
    <form action="{{ route('admin.categories.update', $category->id) }}" method="POST">
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <input type="text" name="name" value="{{ old('name', $category->name) }}" required style="width: 100%; padding: 0.75rem; border: 1px solid #D1D5DB; border-radius: 0.5rem; box-sizing: border-box;">
        </div>
